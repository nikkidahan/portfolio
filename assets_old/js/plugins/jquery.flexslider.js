...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = $('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#"><i class="icon-left-open-mini"></i></a></li><li><a class="' + namespace + 'next" href="#"><i class="icon-right-open-mini"></i></a></li></ul>');
